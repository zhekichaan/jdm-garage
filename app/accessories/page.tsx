        ...
        if (!lastPage) {
          ...
          if (category !== "") {
            const response = await fetch(
              `https://jdm-garage-backend-674d69810b7f.herokuapp.com/api/accessories/category/?category=${category}&page=${page}`
            );
            ...
            setIsLoading(true);
            const response = await fetch(
              `https://jdm-garage-backend-674d69810b7f.herokuapp.com/api/accessories?page=${page}`
            );
            const data = await response.json();
            setAccessoriesList((prevList) => [...prevList, ...data]);
            setIsLoading(false);
